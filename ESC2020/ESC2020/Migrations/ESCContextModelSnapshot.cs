...
{
    [DbContext(typeof(ESCContext))]
    partial class ESCContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ESC2020.Model.Election", b =>
                {
                    ...
                    b.Property<int?>("HostIdElectedId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ESC2020.Model.Election", b =>
                {
                    b.HasOne("ESC2020.Model.Users", "User")
                        .WithMany("Election")
                        .HasForeignKey("HostIdElectedId");

                    b.HasOne("ESC2020.Model.Phase", "Phases")
                        .WithMany("Election")
